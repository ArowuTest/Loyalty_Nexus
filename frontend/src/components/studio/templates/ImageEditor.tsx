    ...
    <div className="space-y-5">
      ...
      <div>
        ...
        <textarea
          ...
          placeholder="Describe what to change — be specific…"
          rows={3}
          autoFocus={!!preview}
          className="nexus-input resize-none w-full text-sm leading-relaxed"
        />
        <p className="text-white/30 text-xs mb-1.5 mt-2">Quick edits:</p>
      ...
      >
        {isLoading
          ? <><Loader2 size={15} className="animate-spin" /> Editing…</>
          : <><Sparkles size={15} /> Edit Image →</>
        }
      </button>
    </div>
  );
