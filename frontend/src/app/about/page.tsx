...
import { Zap, Users, Globe, Cpu, Target, TrendingUp } from "lucide-react";
  ...
  return (
    <main className="min-h-screen" style={{ background: "#0a0b0e", color: "#f0f2ff" }}>
      ...
      <section className="py-16 text-center border-t border-white/[0.06]">
        <h2 className="text-2xl font-black mb-4">Want to learn more?</h2>
        <p className="text-[14px] text-white/40 mb-6">
          We&apos;re building Africa&apos;s most rewarding platform — one recharge at a time.
        </p>
        <div className="flex justify-center gap-3 flex-wrap">
          <Link
            href="/"
            className="px-5 py-2.5 rounded-lg bg-yellow-400 text-black font-black text-[13px] hover:bg-yellow-300 transition-colors"
          >
            Get Started Free
          </Link>
          <a
            href="mailto:hello@loyaltynexus.ng"
            className="px-5 py-2.5 rounded-lg border border-white/[0.1] text-white/60 font-semibold text-[13px] hover:border-white/20 hover:text-white transition-colors"
          >
            Contact Us
          </a>
        </div>
