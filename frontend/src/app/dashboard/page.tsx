      ...
      <header className="flex justify-between items-center">
        ...
        <div className="flex items-center gap-4">
          <div className="text-right">
            <p className="text-xs text-slate-500 font-bold uppercase tracking-widest">PLATINUM TIER</p>
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <div className="glass p-6 rounded-3xl flex flex-col justify-between border border-brand-gold/30">
          <div className="flex justify-between items-start">
            ...
            <div className="bg-green-500/10 text-green-400 text-[10px] font-black px-2 py-1 rounded-full border border-green-500/20 uppercase tracking-widest">
              PASSPORT ACTIVE
            </div>
          </div>
          ...
          <div className="flex gap-2">
            <button className="flex-grow flex items-center justify-center gap-2 bg-white/5 hover:bg-white/10 border border-white/10 py-2.5 rounded-xl text-[10px] font-black uppercase transition-all tracking-widest">
              <Apple size={14} /> Apple
            </button>
            <button className="flex-grow flex items-center justify-center gap-2 bg-white/5 hover:bg-white/10 border border-white/10 py-2.5 rounded-xl text-[10px] font-black uppercase transition-all tracking-widest">
